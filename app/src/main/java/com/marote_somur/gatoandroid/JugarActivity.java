...
public class JugarActivity extends AppCompatActivity {
    //Para comprobar se va a separar cada cadena de combinaciones ganadoras
    // y se va a evaluar cada valor con la cadena de tiros,
    // si las tres son subcadena de la misma entonces ya ganó
        ...
        if (tirosTotalJ2.length >= 3 || tirosTotalJ1.length >= 3) {
            ...
            if (juegoTerminado) {
                if (comprobado) {
                    ...
                    this.gano = false;
                    guardarEstadisticas();
                    AlertDialog mensaje = new AlertDialog.Builder(JugarActivity.this).create();
